...
// // API'den verileri çekmek için fetch kullanımı
...
//   })
//   .then(data => {
//     // Her bir veri öğesi için işlemleri gerçekleştir
//     data.forEach(food => {
//       // Yeni bir post divi oluştur
//       const postDiv = document.createElement('div');
//       postDiv.classList.add('post', 'second_post');

//       // Profil ve iş bilgileri
...
//       profilImg.src = food.image; // API'den gelen resim URL'sini kullan
//       profilImg.alt = food.name; // Resmin alt metni olarak gelen yiyecek adını kullan

//       // İsim ve iş
//       const nameAndJobDiv = document.createElement('div');
//       const nameHeading = document.createElement('h5');
//       nameHeading.textContent = food.name; // Yiyecek adını kullan
//       const jobParagraph = document.createElement('p');
//       jobParagraph.textContent = food.job; // Yiyecek türünü kullan

//       // İsim ve iş divini birleştir
//       nameAndJobDiv.appendChild(nameHeading);
//       nameAndJobDiv.appendChild(jobParagraph);

//       // Profil ve iş bilgilerini birleştir
...
//       postImg.src = food.postImage; // API'den gelen yayın resim URL'sini kullan
//       postImg.alt = food.name; // Resmin alt metni olarak gelen yiyecek adını kullan

//       // Yayın divini oluşturulan resim ile birleştir
//       publicationDiv.appendChild(postImg);

//       // Beğeni ve paylaşma seçenekleri
